...
const computeConfigFields = [
  ...
  { key: "initial_soc", label: "电池初始SOC", type: "number", step: "0.01" },
  { key: "initial_t_bat_c", label: "电芯初始温度(℃)", type: "number", step: "0.1" },
  { key: "initial_t_tank_c", label: "液冷罐初始温度(℃)", type: "number", step: "0.1" },
  { key: "initial_t_cont_c", label: "舱体初始温度(℃)", type: "number", step: "0.1" },
