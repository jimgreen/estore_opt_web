const I18N = {
  zh: {
    ...
    "theme.purple": "科幻紫",
    "theme.workbench": "工作台",
    "home.subtitle": "围绕 Excel 模型定义文件管理多套方案，启动单次 MILP 优化调度、方案校核与批量计算，并横向比较优化与仿真结果。",
    "home.primary": "配置输入",
    "home.secondary": "进入优化调度",
  ...
  en: {
    ...
    "home.subtitle": "Manage multiple Excel-based scenarios, launch MILP optimization dispatch, run scenario checks and batch jobs, then compare optimization and simulation results.",
    "home.primary": "Configure Inputs",
    "home.secondary": "Start Dispatch",
    ...
    "feature.solve.title": "Optimization Dispatch",
    ...
    "solve.title": "Optimization Dispatch",
    "solve.start": "Start",
